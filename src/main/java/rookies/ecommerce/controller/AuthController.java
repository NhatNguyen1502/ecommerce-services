...
public class AuthController {
  ...
  @PostMapping("/sign-up")
  public ResponseEntity<AppApiResponse<Void>> signUp(
  ...
  @PostMapping("/sign-in")
  public ResponseEntity<AppApiResponse<SignInResponse>> login(
      @RequestBody @Valid SignInRequest request) {
    SignInResponse signinResponse = authService.authenticateUser(request);
    return ResponseEntity.ok(
        AppApiResponse.<SignInResponse>builder()
            .code(1000)
            .status(ApiStatus.SUCCESS)
  ...
  public ResponseEntity<AppApiResponse<Object>> refreshToken(
  ...
  @Operation(
      summary = "Logout",
      description = "Invalidate the user's authentication token and refresh token.")
  @ApiResponses(
      value = {
        @ApiResponse(
            responseCode = "200",
