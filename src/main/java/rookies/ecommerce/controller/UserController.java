...
public class UserController {
    ...
    @Operation(summary = "Create a new Customer", description = "Create a new Customer by providing valid customer details.")
    @ApiResponses(value = {
            @ApiResponse(
                    responseCode = "201",
    ...
    @PostMapping
    public ResponseEntity<AppApiResponse<Void>> createCustomer(@Valid @RequestBody CreateCustomerRequest request) {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<AppApiResponse<CustomerDetailResponse>> getCustomerById(@PathVariable String id) {
        try {
    ...
    public ResponseEntity<AppApiResponse<Page<CustomerSumaryResponse>>> getAllCustomers(
        ...
        return ResponseEntity.ok(AppApiResponse.<Page<CustomerSumaryResponse>>builder()
                .code(1000)
                .status(ApiStatus.SUCCESS)
                .message("Get Customers successfully")
                .data(customers)
